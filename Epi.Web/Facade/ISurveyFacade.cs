...
namespace Epi.Web.MVC.Facade
{
    public interface ISurveyFacade
    {
        ...
        MvcDynamicForms.Form GetSurveyFormData(string surveyId, int pageNumber, Epi.Web.Enter.Common.DTO.SurveyAnswerDTO surveyAnswerDTO, bool IsMobileDevice, List<SurveyAnswerDTO> _SurveyAnswerDTOList = null, List<FormsHierarchyDTO> FormsHierarchyDTOList = null);
