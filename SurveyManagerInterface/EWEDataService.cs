    ...
    public class EWEDataService : IEWEDataService
    {
        ...
        public FormSettingResponse GetFormSettings(FormSettingRequest pRequest)
        {
            ...
            try
            {
                ...
                Response.FormSetting = Mapper.ToDataTransferObject(SettingsImplementation.GetFormSettings(pRequest.FormInfo.FormId.ToString(), FormInfoBO.Xml, pRequest.CurrentOrgId, pRequest.FormInfoOnly));
        ...
        public PublishReportResponse GetSurveyReportList(PublishReportRequest publishReportRequest) {
            ...
            try
            {
                ...
                Epi.Web.BLL.Report Implementation = new BLL.Report(IReportDao);
        ...
        public PublishReportResponse GetSurveyReport(PublishReportRequest publishReportRequest)
        {
            ...
            try
            {
                ...
                BLL.Report Implementation = new BLL.Report(IReportDao);
